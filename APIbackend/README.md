...
| API-030 | Support and complaints API | M3 | P0 | Partial | [Specification](../devdocs/APIbackend/00-INDEX.md) | Link cases to scoped operations with escalation and resolution history | owned cases, encrypted replies and staff support operations; private attachments/escalation under API-055 and version-checked staff assignment implemented; live inbound email and SLA automation pending |
...
| API-036 | Load concurrency and release evidence | M4 | P0 | Partial | [Specification](../devdocs/APIbackend/00-INDEX.md) | Execute financial failure suites and meet approved operating objectives | Go race/PostgreSQL, builds and Compose smoke passed in admin candidate run 35961917926; production load/restore and partner acceptance remain outstanding |
