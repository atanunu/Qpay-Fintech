...
function App(){return <Boundary><BrowserRouter><AuthProvider><Routes><Route path="/login" element={<LoginPage/>}/><Route path="/enrol" element={<EnrolPage/>}/><Route path="/accept-invite" element={<InvitePage/>}/><Route path="/recover-access" element={<RecoveryPage/>}/><Route path="/access-help" element={<AccessHelp/>}/><Route element={<Layout/>}><Route index element={<Overview/>}/><Route path="/records/:resource" element={<Records/>}/><Route path="/records/:resource/:id" element={<RecordDetail/>}/><Route path="/policy" element={<PolicyPage/>}/><Route path="/security" element={<SecurityPage/>}/><Route path="/system" element={<SystemPage/>}/><Route path="/reports" element={<ReportsPage/>}/><Route path="/templates" element={<TemplatesPage/>}/><Route path="/identity/:id" element={<IdentityPage/>}/><Route path="*" element={<><h1>Page not found</h1><Link to="/">Return to overview</Link></>}/></Route></Routes></AuthProvider></BrowserRouter></Boundary>}
