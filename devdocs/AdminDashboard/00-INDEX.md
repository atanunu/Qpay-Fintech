# AdminDashboard specification index
Status: planning foundation. Detailed service specifications below are planned, not completed.

[Service README](../../AdminDashboard/README.md) · [Shared index](../00-INDEX.md)

## Scope
Staff operations and independent financial oversight. Approved stack: A1: React + TypeScript + Vite + React Router; approved 2026-09-22. Use the canonical feature register for all task states.
