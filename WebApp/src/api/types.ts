...
export interface QuoteInput { kind: Kind; amount_minor: Money; currency: 'NGN'; narration: string; recipient_id?: string; beneficiary_id?: string; validation_id?: string }
...
export interface Beneficiary { id: string; label: string; account_name: string }
